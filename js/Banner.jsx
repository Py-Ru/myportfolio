    ...
    return (
        <section id="banner" className="flex flex-col justify-center items-center mx-auto">
            ...
            <div class="w-full mt-10">
                <div id="btn-div">
                    <a id="cv-link" href=".\assets\amyr-cv.docx" download class="block text-center bg-white-300 hover:bg-blue-600 border border-violet-950 text-black font-semibold mb-[10px] py-2 px-4 rounded-full shadow">
                        Download CV
                    </a>
                    <button id="quote-btn" onClick="getRandomQuote()" class="block w-full mb-[60px] text-white text-center bg-[#ba68c8] hover:bg-blue-600 border text-black font-semibold py-2 px-4 rounded-full shadow">
                        Get a quote
                    </button>
                </div>
